...
class ProductTestCase(unittest.TestCase):
    ...
    def test_edit_product(self):
        ...
        response = self.client.post(f'/products/edit/{product_id}', data={'name': 'Producto Actualizado','price': 6, 'brand':'Nueva Marca'}, follow_redirects=True)
        self.assertEqual(response.status_code, 200)  # Verifica que la respuesta sea exitosa
    ...
    def test_delete_product(self):
        ...
        response = self.client.get(f'/products/delete/{product_id}', follow_redirects=True)
        self.assertEqual(response.status_code, 200)  # Verifica que la respuesta sea exitosa
